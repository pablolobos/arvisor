...
export default function WhatsAppButton({ phoneNumber }: WhatsAppButtonProps) {
    ...
    return (
        <a
            ...
            className="inline-flex relative items-center gap-2 md:gap-6 bg-brand-purpleHighlight hover:bg-green-600 py-3 rounded-full font-semibold text-white text-base md:text-xl transition-colors duration-200"
        >
