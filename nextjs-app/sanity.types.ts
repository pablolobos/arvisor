...
// Query: *[_type == "project" && defined(slug.current)] | order(_createdAt desc) {      _id,  name,  "slug": slug.current,  subtitle,  location {    address,    mapUrl  },  projectType,  price,  monthlyFee,  tags,  discountPercentage,  images[] {    "url": asset->url,    alt  },  description,  amenities,  details  }
export type AllProjectsQueryResult = Array<never>;
// Variable: projectQuery
// Query: *[_type == "project" && slug.current == $slug][0] {      _id,  name,  "slug": slug.current,  subtitle,  location {    address,    mapUrl  },  projectType,  price,  monthlyFee,  tags,  discountPercentage,  images[] {    "url": asset->url,    alt  },  description,  amenities,  details  }
