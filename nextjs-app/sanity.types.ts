...
// Query: *[_type == "project" && slug.current == $slug][0] {      _id,  name,  "slug": slug.current,  subtitle,  location {    address,    mapUrl  },  projectType,  price,  priceDetail,  downPayment,  downPaymentDetail,  balance,  balanceDetail,  monthlyFee,  tags,  discountPercentage,  images[] {    _key,    _type,    asset->,    hotspot,    crop,    alt  },  description,  amenities,  details,  viewer3dUrl  }
